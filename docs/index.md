...
Runtimes may implement these areas as modes. Ariad defines them as methodological work areas. Maestro, the Mirror extension, may speak of modes because it executes and renders Ariad inside a runtime.
...
- [Work Areas](method/work-areas.md) explains the method-level distinction between Exploration and Delivery.
...
- [Methodological Roots](method/methodological-roots.md) names the different roots behind Exploration and Delivery.
